        ...
        sidebar: {
          '/guide/': [
            { text: 'Start Here', items: [
              ...
              { text: 'Jetson Orin Nano Setup', link: '/guide/jetson-orin-nano-setup' },
              { text: 'Architecture', link: '/guide/architecture' },
              { text: 'Bringup', link: '/guide/bringup' },
              { text: 'Debugging', link: '/guide/debugging' }
            ] },
            { text: 'Hardware and Sensors', items: [
              { text: 'Vehicle Profile', link: '/guide/vehicle-profile' },
              { text: 'Sensors', link: '/guide/sensors' },
              { text: 'Camera Calibration', link: '/guide/camera-calibration' }
            ] },
            { text: 'SLAM and Navigation', items: [
              { text: 'SLAM', link: '/guide/slam' },
              { text: 'Navigation', link: '/guide/navigation' },
              { text: 'Nav2 Speed Optimization', link: '/guide/nav2-speed-optimization' },
              { text: 'Nav2 Tuning', link: '/guide/nav2-tuning' },
              { text: 'Ackermann Navigation', link: '/guide/ackermann-navigation' }
            ] },
          ...
          '/development/': [
            ...
            { text: 'Extension Guides', items: [
              { text: 'Add a New Sensor', link: '/development/add-new-sensor' },
              { text: 'Add a New Navigation Profile', link: '/development/add-new-nav-profile' },
              { text: 'Topic and Frame Naming', link: '/development/topic-and-frame-naming' },
              { text: 'Parameter Style', link: '/development/parameter-style' }
            ] }
          ]
        }
      }
        ...
        sidebar: {
          '/zh/guide/': [
            { text: '入门', items: [
              ...
              { text: 'Jetson Orin Nano 安装', link: '/zh/guide/jetson-orin-nano-setup' },
            ...
            { text: 'SLAM 与导航', items: [
              ...
              { text: 'Nav2 导航提速优化', link: '/zh/guide/nav2-speed-optimization' },
              { text: 'Nav2 调参', link: '/zh/guide/nav2-tuning' },
              { text: 'Ackermann 导航', link: '/zh/guide/ackermann-navigation' }
            ] },
            { text: '故障排查', items: [
          ...
          '/zh/development/': [
            ...
            { text: '扩展指南', items: [
              ...
              { text: '新增导航 Profile', link: '/zh/development/add-new-nav-profile' },
              { text: 'Topic 和 Frame 命名', link: '/zh/development/topic-and-frame-naming' },
